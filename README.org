...
Currently it is using maximum profit-over-weight-ratio of the knapsack items as a penalty. We can try death penalty, repair strategy to see its effect on solution quality and convergence speed.
#+begin_src julia
